...
public partial class AcidDisplay : Control
{
    ...
    public override void _Ready()
    {
        ...
        OutdatedDna = new outdated_DNA(new RandomNumberGenerator());
        //Console.WriteLine(_container.GetChildren()); //acidletter in by here
        _buttonBase.Show();
        CricketVisuals.GenerateNodeGrid(_buttonBase,
            _acidLetter.SpriteFrames.GetFrameTexture("A", 0).GetSize(), 1, OutdatedDna.GetLength(), _container,
